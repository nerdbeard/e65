...
** Assembler
To be provided by or modelled after COMFY or COMFY-6502
** Disassembler
To be written
...
Hmm, no, that's COMFY-6502.  COMFY just outputs the raw code:
#+BEGIN_SRC elisp
  (comfy-init)
...
I guess maybe I could port COMFY-6502 *back* to elisp.  It has the same crappy license as COMFY though.  Not that I aspire to have commercial applications, but there are licensing requirements I don't want to deal with just for redistribution.
** Monitor/debugger
To be written
* References
...
This is my version of COMFY ported to modern elisp and without the namespace pollution.  I used this to clean it up from the original:
...
#+BEGIN_SRC elisp
  ...
  (comfy-subseq comfy-mem (comfy-compile upcwand 'win 'lose))
#+END_SRC

#+RESULTS:
: [162 6 224 12 176 10 181 11 73 127 149 11 232 76 4 0 162 0 224 12 176 23 181 11 160 0 192 10 176 56 217 90 0 240 4 200 76 28 0 148 12 232 76 20 0 248 169 0 162 0 224 12 176 7 117 12 232 232 76 52 0 133 13 24 101 13 101 13 162 1 224 12 176 7 117 12 232 232 76 72 0 73 15 208 1 96 nil 96 13 25 19 61 35 49 47 59 55 11]

Hey, what's that `nil` doing in there?
* emacs-nes
